        ...
        <div className="bg-black h-screen">
            ...
            <div className="p-8 max-w-lg mx-auto mt-32">
                ...
                <div className="mb-6">
                    ...
                    <textarea className="shadow appearance-none border rounded w-full h-48 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline message-textarea" cols="10" placeholder="Your message here..."/>
                </div>
